...
<div class="component_stockdetail">
	<div class="pagetopnav">
		...
		<ul class="navPage blocklistright">
			...
			<li>
				<a class="grey-btn" href="<%=userSession.getBackToShopURL()%>"> <%=website.getText("detailbacktoshopbutton","Back to shop")%> </a>
			</li>
		</ul>
	</div>
	...
	<%@include file="/template/template_stockdetail.jsp"%>
	...
	<div class="pagebottomnav">
		...
		<ul class="navPage blocklistright">
			...
			<% if (userSession.hasActiveGiftList()) { %>
				<li>
					<a class="grey-btn"  href="viewList.jsp?listcode=<%=userSession.getGiftListCode()%>"> <%=website.getText("detailbacktogiftlistbutton","Back to Giftlist")%> </a>
				</li>
			<% } %>
			<% if (pageModel.getPersonalShopperTransactionId() > 0) { %>
				<li>

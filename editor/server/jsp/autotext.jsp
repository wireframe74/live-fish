...
<%
  ...
  pe.setAbsoluteImageUrl(request.getParameter("iu"));
  pe.setAbsoluteImagePath(request.getParameter("ip"));
  pe.setAbsoluteAutoTextUrl(request.getParameter("au"));
  pe.setAbsoluteAutoTextPath(request.getParameter("ap"));
  pe.setLanguage(request.getParameter("lg"));
  String style = (String) request.getParameter("st");
  pe.setDisplayStyle(style);
  pe.setToolbarXMLPath(application.getRealPath("") + "\\editor\\config\\xml-toolbar\\toolbar-at.xml");
